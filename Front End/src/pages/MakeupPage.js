...
const Fragrances = () => {
  return (<Design>
    <div className='space'>
        ...
        <p> <KeyboardArrowRightIcon></KeyboardArrowRightIcon>Makeup products</p></div>
        <div><h5 className='center pb-3'>Makeup Products</h5></div>
...
<div className='category d-flex mt-5'>
